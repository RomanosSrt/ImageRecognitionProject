...
def main():
    ...
    distance_metric = "cosine"  # Change to "cosine" or "jaccard" as needed
    k_values = list(range(1, 11))  # Test k from 2 to 10
    inertias = []
    silhouettes = []
    ...
    for k in k_values:
        ...
        print(f"    Inertia: {inertia:.2f} | Silhouette: {silhouette_str}")
